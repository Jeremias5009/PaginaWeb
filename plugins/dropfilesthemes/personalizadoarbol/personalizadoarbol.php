 ...
 * Content Plugin.
 */
class PlgDropfilesthemesPersonalizadoarbol extends DropfilesPluginBase
{
    /**
     * Theme name
     *
     * @var string
     */
    public $name = 'personalizadoarbol';
    ...
    public function onShowFrontCategory($options)
    {
        ...
        $doc->addScript(JURI::base('true') . '/plugins/dropfilesthemes/personalizadoarbol/js/script.js');
        ...
        $doc->addStyleSheet(JURI::base('true') . '/plugins/dropfilesthemes/personalizadoarbol/css/style_ver5.4.css');
        ...
        if (!empty($this->options['files']) ||
            ...
            $this->download_popup     = DropfilesBase::loadValue($this->options['params'], 'personalizadoarbol_download_popup', 1);
            $style                    = '';
            $style .= ' #dropfiles-box-personalizadoarbol .dropblock .extra-downloadlink a, .dropfiles-content-personalizadoarbol .download-all, .dropfiles-content-personalizadoarbol .download-selected {background-color:';
            $style .= DropfilesBase::loadValue($this->params, 'personalizadoarbol_bgdownloadlink', '#006DCC') . ' !important;color:';
            $style .= DropfilesBase::loadValue($this->params, 'personalizadoarbol_colordownloadlink', '#fff') . ' !important;}';
