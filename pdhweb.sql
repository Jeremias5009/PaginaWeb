...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-02-2024 a las 01:43:20
...
--
-- Base de datos: `pdhweb`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_action_logs`
--

CREATE TABLE `pdh_action_logs` (
...
--
-- Volcado de datos para la tabla `pdh_action_logs`
--

INSERT INTO `pdh_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{\"action\":\"login\",\"userid\":632,\"username\":\"administrador\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=632\",\"app\":\"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR\"}', '2024-02-15 00:39:33', 'com_users', 632, 0, 'COM_ACTIONLOGS_DISABLED'),
(2, 'PLG_ACTIONLOG_JOOMLA_PLUGIN_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PLUGIN\",\"id\":239,\"name\":\"Astroid Plugin\",\"extension_name\":\"Astroid Plugin\",\"userid\":632,\"username\":\"administrador\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=632\"}', '2024-02-15 00:40:22', 'com_installer', 632, 239, 'COM_ACTIONLOGS_DISABLED'),
(3, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MODULE\",\"id\":240,\"name\":\"Astroid Clear Cache\",\"extension_name\":\"Astroid Clear Cache\",\"userid\":632,\"username\":\"administrador\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=632\"}', '2024-02-15 00:40:22', 'com_installer', 632, 240, 'COM_ACTIONLOGS_DISABLED'),
(4, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MODULE\",\"id\":241,\"name\":\"mod_astroid_menu\",\"extension_name\":\"mod_astroid_menu\",\"userid\":632,\"username\":\"administrador\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=632\"}', '2024-02-15 00:40:22', 'com_installer', 632, 241, 'COM_ACTIONLOGS_DISABLED'),
(5, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_LIBRARY\",\"id\":238,\"name\":\"Astroid Framework\",\"extension_name\":\"Astroid Framework\",\"userid\":632,\"username\":\"administrador\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=632\"}', '2024-02-15 00:40:22', 'com_installer', 632, 238, 'COM_ACTIONLOGS_DISABLED'),
(6, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_TEMPLATE\",\"id\":242,\"name\":\"astroid_template_two\",\"extension_name\":\"astroid_template_two\",\"userid\":632,\"username\":\"administrador\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=632\"}', '2024-02-15 00:40:22', 'com_installer', 632, 242, 'COM_ACTIONLOGS_DISABLED'),
(7, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_TEMPLATE\",\"id\":243,\"name\":\"astroid_template_one\",\"extension_name\":\"astroid_template_one\",\"userid\":632,\"username\":\"administrador\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=632\"}', '2024-02-15 00:40:22', 'com_installer', 632, 243, 'COM_ACTIONLOGS_DISABLED'),
(8, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_TEMPLATE\",\"id\":244,\"name\":\"astroid_template_zero\",\"extension_name\":\"astroid_template_zero\",\"userid\":632,\"username\":\"administrador\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=632\"}', '2024-02-15 00:40:22', 'com_installer', 632, 244, 'COM_ACTIONLOGS_DISABLED'),
(9, 'PLG_ACTIONLOG_JOOMLA_EXTENSION_INSTALLED', '{\"action\":\"install\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_PACKAGE\",\"id\":245,\"name\":\"Astroid Package\",\"extension_name\":\"Astroid Package\",\"userid\":632,\"username\":\"administrador\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=632\"}', '2024-02-15 00:40:22', 'com_installer', 632, 245, 'COM_ACTIONLOGS_DISABLED'),
(10, 'PLG_SYSTEM_ACTIONLOGS_CONTENT_ADDED', '{\"action\":\"add\",\"type\":\"PLG_ACTIONLOG_JOOMLA_TYPE_MODULE\",\"id\":112,\"title\":\"busqueda\",\"extension_name\":\"busqueda\",\"itemlink\":\"index.php?option=com_modules&task=module.edit&id=112\",\"userid\":632,\"username\":\"administrador\",\"accountlink\":\"index.php?option=com_users&task=user.edit&id=632\"}', '2024-02-15 00:42:18', 'com_modules.module', 632, 112, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_action_logs_extensions`
--

CREATE TABLE `pdh_action_logs_extensions` (
  `id` int(10) UNSIGNED NOT NULL,
  `extension` varchar(255) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `pdh_action_logs_extensions`
--

INSERT INTO `pdh_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Estructura de tabla para la tabla `pdh_action_logs_users`
--

CREATE TABLE `pdh_action_logs_users` (
...
--
-- Estructura de tabla para la tabla `pdh_action_log_config`
--

CREATE TABLE `pdh_action_log_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `pdh_action_log_config`
--

INSERT INTO `pdh_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Estructura de tabla para la tabla `pdh_assets`
--

CREATE TABLE `pdh_assets` (
...
--
-- Volcado de datos para la tabla `pdh_assets`
--

INSERT INTO `pdh_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(98, 18, 134, 135, 2, 'com_modules.module.110', 'Astroid Clear Cache', '{}'),
(99, 18, 136, 137, 2, 'com_modules.module.111', 'Astroid Menu', '{}'),
(100, 18, 138, 139, 2, 'com_modules.module.112', 'busqueda', '{}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_associations`
--

CREATE TABLE `pdh_associations` (
...
--
-- Estructura de tabla para la tabla `pdh_banners`
--

CREATE TABLE `pdh_banners` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_banner_clients`
--

CREATE TABLE `pdh_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `pdh_banner_tracks`
--

CREATE TABLE `pdh_banner_tracks` (
...
--
-- Estructura de tabla para la tabla `pdh_categories`
--

CREATE TABLE `pdh_categories` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `pdh_categories`
--

INSERT INTO `pdh_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '{}', '', '', '{}', 632, '2024-02-15 00:38:34', 632, '2024-02-15 00:38:34', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\",\"workflow_id\":\"use_default\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 632, '2024-02-15 00:38:34', 632, '2024-02-15 00:38:34', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 632, '2024-02-15 00:38:34', 632, '2024-02-15 00:38:34', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 632, '2024-02-15 00:38:34', 632, '2024-02-15 00:38:34', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 632, '2024-02-15 00:38:34', 632, '2024-02-15 00:38:34', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 632, '2024-02-15 00:38:34', 632, '2024-02-15 00:38:34', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_contact_details`
--

CREATE TABLE `pdh_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_content`
--

CREATE TABLE `pdh_content` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(400) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `pdh_contentitem_tag_map`
--

CREATE TABLE `pdh_contentitem_tag_map` (
  `type_alias` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `pdh_content_frontpage`
--

CREATE TABLE `pdh_content_frontpage` (
...
--
-- Estructura de tabla para la tabla `pdh_content_rating`
--

CREATE TABLE `pdh_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT 0,
...
--
-- Estructura de tabla para la tabla `pdh_content_types`
--

CREATE TABLE `pdh_content_types` (
...
--
-- Volcado de datos para la tabla `pdh_content_types`
--

INSERT INTO `pdh_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Estructura de tabla para la tabla `pdh_extensions`
--

CREATE TABLE `pdh_extensions` (
...
--
-- Volcado de datos para la tabla `pdh_extensions`
--

INSERT INTO `pdh_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `changelogurl`, `folder`, `client_id`, `enabled`, `access`, `protected`, `locked`, `manifest_cache`, `params`, `custom_data`, `checked_out`, `checked_out_time`, `ordering`, `state`, `note`) VALUES
...
(10, 0, 'com_languages', 'component', 'com_languages', NULL, '', 1, 1, 1, 1, 1, '{\"name\":\"com_languages\",\"type\":\"component\",\"creationDate\":\"2006-04\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2006 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.0.0\",\"description\":\"COM_LANGUAGES_XML_DESCRIPTION\",\"group\":\"\",\"namespace\":\"Joomla\\\\Component\\\\Languages\"}', '{\"administrator\":\"es-ES\",\"site\":\"es-ES\"}', '', NULL, NULL, 0, 0, NULL),
...
(188, 0, 'plg_system_stats', 'plugin', 'stats', NULL, 'system', 0, 0, 1, 0, 1, '{\"name\":\"plg_system_stats\",\"type\":\"plugin\",\"creationDate\":\"2013-11\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2013 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_STATS_XML_DESCRIPTION\",\"group\":\"\",\"namespace\":\"Joomla\\\\Plugin\\\\System\\\\Stats\",\"filename\":\"stats\"}', '{\"mode\":3,\"lastrun\":1707957590,\"unique_id\":\"8995601a8b73cf52f9b0e196c7ca4806eee9241e\",\"interval\":12}', '', NULL, NULL, 21, 0, NULL),
...
(190, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', NULL, 'system', 0, 1, 1, 0, 1, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"2015-05\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2015 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"namespace\":\"Joomla\\\\Plugin\\\\System\\\\UpdateNotification\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1707957565}', '', NULL, NULL, 23, 0, NULL),
...
(229, 0, 'files_joomla', 'file', 'joomla', NULL, '', 0, 1, 1, 1, 1, '{\"name\":\"files_joomla\",\"type\":\"file\",\"creationDate\":\"2023-10\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2019 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.4.0\",\"description\":\"FILES_JOOMLA_XML_DESCRIPTION\",\"group\":\"\"}', '', '', NULL, NULL, 0, 0, NULL),
(230, 0, 'English (en-GB) Language Pack', 'package', 'pkg_en-GB', NULL, '', 0, 1, 1, 1, 1, '{\"name\":\"English (en-GB) Language Pack\",\"type\":\"package\",\"creationDate\":\"2023-10\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2019 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.4.0.1\",\"description\":\"en-GB language pack\",\"group\":\"\",\"filename\":\"pkg_en-GB\"}', '', '', NULL, NULL, 0, 0, NULL),
(231, 230, 'English (en-GB)', 'language', 'en-GB', NULL, '', 0, 1, 1, 1, 1, '{\"name\":\"English (en-GB)\",\"type\":\"language\",\"creationDate\":\"2023-10\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2006 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.4.0\",\"description\":\"en-GB site language\",\"group\":\"\"}', '', '', NULL, NULL, 0, 0, NULL),
(232, 230, 'English (en-GB)', 'language', 'en-GB', NULL, '', 1, 1, 1, 1, 1, '{\"name\":\"English (en-GB)\",\"type\":\"language\",\"creationDate\":\"2023-10\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2005 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.4.0\",\"description\":\"en-GB administrator language\",\"group\":\"\"}', '', '', NULL, NULL, 0, 0, NULL),
(233, 230, 'English (en-GB)', 'language', 'en-GB', NULL, '', 3, 1, 1, 1, 1, '{\"name\":\"English (en-GB)\",\"type\":\"language\",\"creationDate\":\"2023-10\",\"author\":\"Joomla! Project\",\"copyright\":\"(C) 2020 Open Source Matters, Inc.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"4.4.0\",\"description\":\"en-GB api language\",\"group\":\"\"}', '', '', NULL, NULL, 0, 0, NULL),
(234, 237, 'Spanish (es-ES)', 'language', 'es-ES', '', '', 0, 1, 0, 0, 0, '{\"name\":\"Spanish (es-ES)\",\"type\":\"language\",\"creationDate\":\"2024-01\",\"author\":\"Spanish [es-ES] Translation Team\",\"copyright\":\"(C) 2013 Open Source Matters, Inc.\",\"authorEmail\":\"traduccion@joomlaes.org\",\"authorUrl\":\"https:\\/\\/joomlaes.org\\/traduccion\",\"version\":\"4.4.2.1\",\"description\":\"<p>Spanish [es-ES] language pack (site) for Joomla!<\\/p><p><\\/p><p>Paquete de idioma espa\\u00f1ol [es-ES] (sitio) para Joomla!<\\/p>\",\"group\":\"\",\"filename\":\"install\"}', '{}', '', NULL, NULL, 0, 0, NULL),
(235, 237, 'Spanish (es-ES)', 'language', 'es-ES', '', '', 1, 1, 0, 0, 0, '{\"name\":\"Spanish (es-ES)\",\"type\":\"language\",\"creationDate\":\"2024-01\",\"author\":\"Spanish [es-ES] Translation Team\",\"copyright\":\"(C) 2013 Open Source Matters, Inc.\",\"authorEmail\":\"traduccion@joomlaes.org\",\"authorUrl\":\"https:\\/\\/joomlaes.org\\/traduccion\",\"version\":\"4.4.2.1\",\"description\":\"<p>Spanish [es-ES] language pack (administrator) for Joomla!<\\/p><p><\\/p><p>Paquete de idioma espa\\u00f1ol [es-ES] (administrador) para Joomla!<\\/p>\",\"group\":\"\",\"filename\":\"install\"}', '{}', '', NULL, NULL, 0, 0, NULL),
(236, 237, 'Spanish (es-ES)', 'language', 'es-ES', '', '', 3, 1, 0, 0, 0, '{\"name\":\"Spanish (es-ES)\",\"type\":\"language\",\"creationDate\":\"2024-01\",\"author\":\"Spanish [es-ES] Translation Team\",\"copyright\":\"Copyright (C) 2005 - 2022 Open Source Matters, Inc.\",\"authorEmail\":\"traduccion@joomlaes.org\",\"authorUrl\":\"https:\\/\\/joomlaes.org\\/traduccion\",\"version\":\"4.4.2.1\",\"description\":\"Idioma es-ES de la api\",\"group\":\"\",\"filename\":\"install\"}', '{}', '', NULL, NULL, 0, 0, NULL),
(237, 0, 'Spanish (es-ES) Language Pack', 'package', 'pkg_es-ES', '', '', 0, 1, 1, 0, 0, '{\"name\":\"Spanish (es-ES) Language Pack\",\"type\":\"package\",\"creationDate\":\"2024-01\",\"author\":\"Spanish [es-ES] Translation Team\",\"copyright\":\"Copyright (C) 2005 - 2023 Open Source Matters, Inc.\",\"authorEmail\":\"traduccion@joomlaes.org\",\"authorUrl\":\"https:\\/\\/joomlaes.org\\/traduccion\",\"version\":\"4.4.2.1\",\"description\":\"<div style=\\\"text-align: left;\\\"><h2>Successfully installed the Joomla! 4.4.2 Spanish es-ES Language Pack (v1)<\\/h2><p><\\/p><p>Please report any bugs or issues at the Spanish Translation Team using the mail: traduccion@joomlaes.org<\\/p><p>If you wanna help with translations matters the site is at: <a href=\'https:\\/\\/joomlaes.org\\/traduccion\' target=\'_blank\' rel=\'noopener noreferrer\'>JoomlaES.org<\\/a> Contact Us!<\\/p><p><\\/p><p>Translated by: The Spanish Translation Team [es-ES]<\\/p><h2>El paquete del idioma en espa\\u00f1ol es-ES (v1) para Joomla! 4.4.2 se ha instalado correctamente.<\\/h2><p><\\/p><p>Por favor, reporte cualquier bug o asunto relacionado a nuestra direcci\\u00f3n de correo electr\\u00f3nico: traduccion@joomlaes.org<\\/p><p>Si quiere colaborar con el trabajo de traducci\\u00f3n estamos en: <a href=\'https:\\/\\/joomlaes.org\\/traduccion\' target=\'_blank\' rel=\'noopener noreferrer\'>JoomlaES.org<\\/a> \\u00a1Contacte con nosotros!<\\/p><p><\\/p><p>Traducci\\u00f3n: Spanish Translation Team [es-ES]<\\/p><\\/div>\",\"group\":\"\",\"filename\":\"pkg_es-ES\"}', '{}', '', NULL, NULL, 0, 0, NULL),
(238, 245, 'Astroid Framework', 'library', 'astroid', '', '', 0, 1, 1, 0, 0, '{\"name\":\"Astroid Framework\",\"type\":\"library\",\"creationDate\":\"January 2024\",\"author\":\"Astroid Framework Team\",\"copyright\":\"Copyright (C) 2024 TemPlaza, Inc. All rights reserved.\",\"authorEmail\":\"info@templaza.com\",\"authorUrl\":\"https:\\/\\/www.templaza.com\",\"version\":\"3.0.9\",\"description\":\"Astroid Template Framework by TemPlaza\",\"group\":\"\",\"filename\":\"astroid\"}', '{}', '', NULL, NULL, 0, 0, NULL),
(239, 245, 'Astroid Plugin', 'plugin', 'astroid', '', 'system', 0, 1, 1, 0, 0, '{\"name\":\"Astroid Plugin\",\"type\":\"plugin\",\"creationDate\":\"November 2023\",\"author\":\"Astroid Framework Team\",\"copyright\":\"Copyright (C) 2023 TemPlaza, Inc. All rights reserved.\",\"authorEmail\":\"info@templaza.com\",\"authorUrl\":\"https:\\/\\/www.templaza.com\",\"version\":\"3.0.5\",\"description\":\"Astroid Framework Plugin Description Here\",\"group\":\"\",\"namespace\":\"Joomla\\\\Plugin\\\\System\\\\Astroid\",\"filename\":\"astroid\"}', '{\"astroid_load_fontawesome\":\"cdn\",\"astroid_inline_css\":\"0\",\"astroid_shortcut_enable\":\"1\",\"astroid_color_mode_enable\":\"0\",\"astroid_remove_generator\":\"0\",\"astroid_debug\":\"0\",\"frontend_tabs_visibility\":\"1\"}', '', NULL, NULL, 0, 0, NULL),
(240, 245, 'Astroid Clear Cache', 'module', 'mod_astroid_clear_cache', '', '', 1, 1, 2, 0, 0, '{\"name\":\"Astroid Clear Cache\",\"type\":\"module\",\"creationDate\":\"October 2023\",\"author\":\"TemPlaza\",\"copyright\":\"(C) 2022 TemPlaza.com.\",\"authorEmail\":\"support@templaza.com\",\"authorUrl\":\"www.templaza.com\",\"version\":\"3.0.3\",\"description\":\"Astroid Clear Cache Module\",\"group\":\"\",\"filename\":\"mod_astroid_clear_cache\"}', '[]', '', NULL, NULL, 0, 0, NULL),
(241, 245, 'mod_astroid_menu', 'module', 'mod_astroid_menu', '', '', 0, 1, 0, 0, 0, '{\"name\":\"mod_astroid_menu\",\"type\":\"module\",\"creationDate\":\"June 2nd, 2023\",\"author\":\"Astroid Framework\",\"copyright\":\"(C) 2023 Astroid Framework\",\"authorEmail\":\"sonlv@templaza.com\",\"authorUrl\":\"astroidframe.work\",\"version\":\"1.0.0\",\"description\":\"MOD_ASTROID_MENU_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"mod_astroid_menu\"}', '{\"startLevel\":\"1\",\"endLevel\":\"0\",\"showAllChildren\":\"1\",\"menu_breakpoint\":\"lg\",\"layout\":\"_:default\",\"cache\":\"1\",\"cache_time\":\"900\",\"cachemode\":\"itemid\"}', '', NULL, NULL, 0, 0, NULL),
(242, 245, 'astroid_template_two', 'template', 'astroid_template_two', '', '', 0, 1, 1, 0, 0, '{\"name\":\"astroid_template_two\",\"type\":\"template\",\"creationDate\":\"January 2024\",\"author\":\"Astroid Framework\",\"copyright\":\"Copyright (C) 2024 AstroidFrame.work, Inc. All rights reserved.\",\"authorEmail\":\"sonlv@templaza.com\",\"authorUrl\":\"https:\\/\\/astroidframe.work\",\"version\":\"1.0.1\",\"description\":\"TPL_ASTROID_XML_DESCRIPTION\",\"group\":\"\",\"inheritable\":true,\"filename\":\"templateDetails\"}', '[]', '', NULL, NULL, 0, 0, NULL),
(243, 245, 'astroid_template_one', 'template', 'astroid_template_one', '', '', 0, 1, 1, 0, 0, '{\"name\":\"astroid_template_one\",\"type\":\"template\",\"creationDate\":\"October 2023\",\"author\":\"Astroid Framework\",\"copyright\":\"Copyright (C) 2023 AstroidFrame.work, Inc. All rights reserved.\",\"authorEmail\":\"info@templaza.com\",\"authorUrl\":\"https:\\/\\/astroidframe.work\",\"version\":\"3.0.8\",\"description\":\"TPL_ASTROID_XML_DESCRIPTION\",\"group\":\"\",\"inheritable\":true,\"filename\":\"templateDetails\"}', '[]', '', NULL, NULL, 0, 0, NULL),
(244, 245, 'astroid_template_zero', 'template', 'astroid_template_zero', '', '', 0, 1, 1, 0, 0, '{\"name\":\"astroid_template_zero\",\"type\":\"template\",\"creationDate\":\"December 2023\",\"author\":\"Astroid Framework\",\"copyright\":\"Copyright (C) 2023 AstroidFrame.work, Inc. All rights reserved.\",\"authorEmail\":\"info@templaza.com\",\"authorUrl\":\"https:\\/\\/astroidframe.work\",\"version\":\"3.0.8\",\"description\":\"TPL_ASTROID_XML_DESCRIPTION\",\"group\":\"\",\"inheritable\":true,\"filename\":\"templateDetails\"}', '[]', '', NULL, NULL, 0, 0, NULL),
(245, 0, 'Astroid Package', 'package', 'pkg_astroid', '', '', 0, 1, 1, 0, 0, '{\"name\":\"Astroid Package\",\"type\":\"package\",\"creationDate\":\"January 2024\",\"author\":\"Astroid Framework\",\"copyright\":\"Copyright (C) 2024 AstroidFrame.work. All rights reserved.\",\"authorEmail\":\"info@templaza.com\",\"authorUrl\":\"https:\\/\\/astroidframe.work\",\"version\":\"3.0.9\",\"description\":\"\",\"group\":\"\",\"filename\":\"pkg_astroid\"}', '{}', '', NULL, NULL, 0, 0, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_fields`
--

CREATE TABLE `pdh_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_fields_categories`
--

CREATE TABLE `pdh_fields_categories` (
...
--
-- Estructura de tabla para la tabla `pdh_fields_groups`
--

CREATE TABLE `pdh_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `context` varchar(255) NOT NULL DEFAULT '',
  `title` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `pdh_fields_values`
--

CREATE TABLE `pdh_fields_values` (
...
--
-- Estructura de tabla para la tabla `pdh_finder_filters`
--

CREATE TABLE `pdh_finder_filters` (
...
--
-- Estructura de tabla para la tabla `pdh_finder_links`
--

CREATE TABLE `pdh_finder_links` (
...
--
-- Estructura de tabla para la tabla `pdh_finder_links_terms`
--

CREATE TABLE `pdh_finder_links_terms` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_finder_logging`
--

CREATE TABLE `pdh_finder_logging` (
...
--
-- Estructura de tabla para la tabla `pdh_finder_taxonomy`
--

CREATE TABLE `pdh_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `pdh_finder_taxonomy`
--

INSERT INTO `pdh_finder_taxonomy` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `state`, `access`, `language`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', 1, 1, '*');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_finder_taxonomy_map`
--

CREATE TABLE `pdh_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_finder_terms`
--

CREATE TABLE `pdh_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_finder_terms_common`
--

CREATE TABLE `pdh_finder_terms_common` (
...
--
-- Volcado de datos para la tabla `pdh_finder_terms_common`
--

INSERT INTO `pdh_finder_terms_common` (`term`, `language`, `custom`) VALUES
('a', 'en', 0),
('a', 'es', 0),
('abajo', 'es', 0),
('about', 'en', 0),
...
--
-- Estructura de tabla para la tabla `pdh_finder_tokens`
--

CREATE TABLE `pdh_finder_tokens` (
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
  `phrase` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Estructura de tabla para la tabla `pdh_finder_tokens_aggregate`
--

CREATE TABLE `pdh_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
  `term` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `stem` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `common` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Estructura de tabla para la tabla `pdh_finder_types`
--

CREATE TABLE `pdh_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_guidedtours`
--

CREATE TABLE `pdh_guidedtours` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL DEFAULT '',
  `description` text NOT NULL,
  `ordering` int(11) NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `pdh_guidedtours`
--

INSERT INTO `pdh_guidedtours` (`id`, `title`, `description`, `ordering`, `extensions`, `url`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`, `published`, `language`, `note`, `access`) VALUES
(1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_TITLE', 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_DESCRIPTION', 1, '[\"com_guidedtours\"]', 'administrator/index.php?option=com_guidedtours&view=tours', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, 1, '*', '', 1),
(2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_TITLE', 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_DESCRIPTION', 2, '[\"com_guidedtours\"]', 'administrator/index.php?option=com_guidedtours&view=tours', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, 1, '*', '', 1),
(3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_TITLE', 'COM_GUIDEDTOURS_TOUR_ARTICLES_DESCRIPTION', 3, '[\"*\"]', 'administrator/index.php?option=com_content&view=articles', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, 1, '*', '', 1),
(4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_TITLE', 'COM_GUIDEDTOURS_TOUR_CATEGORIES_DESCRIPTION', 4, '[\"*\"]', 'administrator/index.php?option=com_categories&view=categories&extension=com_content', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, 1, '*', '', 1),
(5, 'COM_GUIDEDTOURS_TOUR_MENUS_TITLE', 'COM_GUIDEDTOURS_TOUR_MENUS_DESCRIPTION', 5, '[\"*\"]', 'administrator/index.php?option=com_menus&view=menus', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, 1, '*', '', 1),
(6, 'COM_GUIDEDTOURS_TOUR_TAGS_TITLE', 'COM_GUIDEDTOURS_TOUR_TAGS_DESCRIPTION', 6, '[\"*\"]', 'administrator/index.php?option=com_tags&view=tags', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, 1, '*', '', 1),
(7, 'COM_GUIDEDTOURS_TOUR_BANNERS_TITLE', 'COM_GUIDEDTOURS_TOUR_BANNERS_DESCRIPTION', 7, '[\"*\"]', 'administrator/index.php?option=com_banners&view=banners', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, 1, '*', '', 1),
(8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_TITLE', 'COM_GUIDEDTOURS_TOUR_CONTACTS_DESCRIPTION', 8, '[\"*\"]', 'administrator/index.php?option=com_contact&view=contacts', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, 1, '*', '', 1),
(9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_TITLE', 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_DESCRIPTION', 9, '[\"*\"]', 'administrator/index.php?option=com_newsfeeds&view=newsfeeds', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, 1, '*', '', 1),
(10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_TITLE', 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_DESCRIPTION', 10, '[\"*\"]', 'administrator/index.php?option=com_finder&view=filters', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, 1, '*', '', 1),
(11, 'COM_GUIDEDTOURS_TOUR_USERS_TITLE', 'COM_GUIDEDTOURS_TOUR_USERS_DESCRIPTION', 11, '[\"*\"]', 'administrator/index.php?option=com_users&view=users', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, 1, '*', '', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_guidedtour_steps`
--

CREATE TABLE `pdh_guidedtour_steps` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `pdh_guidedtour_steps`
--

INSERT INTO `pdh_guidedtour_steps` (`id`, `tour_id`, `title`, `published`, `description`, `ordering`, `position`, `target`, `type`, `interactive_type`, `url`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`, `language`, `note`) VALUES
(1, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_NEW_DESCRIPTION', 1, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_guidedtours&view=tours', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(2, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_TITLE_DESCRIPTION', 2, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(3, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_URL_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_URL_DESCRIPTION', 3, 'top', '#jform_url', 2, 2, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(4, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_CONTENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_CONTENT_DESCRIPTION', 4, 'bottom', '#jform_description,#jform_description_ifr', 2, 3, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(5, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_COMPONENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_COMPONENT_DESCRIPTION', 5, 'top', 'joomla-field-fancy-select .choices', 2, 3, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(6, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_SAVECLOSE_DESCRIPTION', 6, 'top', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(7, 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURS_STEP_CONGRATULATIONS_DESCRIPTION', 7, 'bottom', '', 0, 1, 'administrator/index.php?option=com_guidedtours&view=tour&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(8, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_COUNTER_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_COUNTER_DESCRIPTION', 8, 'top', '#toursList tbody tr:nth-last-of-type(1) td:nth-of-type(5) .btn', 2, 1, '', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(9, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_NEW_DESCRIPTION', 9, 'bottom', '.button-new', 2, 1, '', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(10, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TITLE_DESCRIPTION', 10, 'bottom', '#jform_title', 2, 2, '', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(11, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_DESCRIPTION_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_DESCRIPTION_DESCRIPTION', 11, 'bottom', '#jform_description,#jform_description_ifr', 2, 3, '', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(12, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_STATUS_DESCRIPTION', 12, 'bottom', '#jform_published', 2, 3, '', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(13, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_POSITION_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_POSITION_DESCRIPTION', 13, 'top', '#jform_position', 2, 3, '', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(14, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TARGET_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TARGET_DESCRIPTION', 14, 'top', '#jform_target', 2, 3, '', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(15, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TYPE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_TYPE_DESCRIPTION', 15, 'top', '#jform_type', 2, 3, '', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(16, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_SAVECLOSE_DESCRIPTION', 16, 'bottom', '#save-group-children-save .button-save', 2, 1, '', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(17, 2, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_GUIDEDTOURSTEPS_STEP_CONGRATULATIONS_DESCRIPTION', 17, 'bottom', '', 0, 1, '', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(18, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_NEW_DESCRIPTION', 18, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_content&view=articles', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(19, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_TITLE_DESCRIPTION', 19, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(20, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_ALIAS_DESCRIPTION', 20, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(21, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CONTENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CONTENT_DESCRIPTION', 21, 'bottom', '#jform_articletext,#jform_articletext_ifr', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(22, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_STATUS_DESCRIPTION', 22, 'bottom', '#jform_state', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(23, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CATEGORY_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CATEGORY_DESCRIPTION', 23, 'top', 'joomla-field-fancy-select .choices[data-type=select-one]', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(24, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_FEATURED_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_FEATURED_DESCRIPTION', 24, 'bottom', '#jform_featured0', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(25, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_ACCESS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_ACCESS_DESCRIPTION', 25, 'bottom', '#jform_access', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(26, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_TAGS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_TAGS_DESCRIPTION', 26, 'top', 'joomla-field-fancy-select .choices[data-type=select-multiple]', 2, 3, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(27, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_NOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_NOTE_DESCRIPTION', 27, 'top', '#jform_note', 2, 2, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(28, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_VERSIONNOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_VERSIONNOTE_DESCRIPTION', 28, 'top', '#jform_version_note', 2, 2, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(29, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_SAVECLOSE_DESCRIPTION', 29, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(30, 3, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_ARTICLES_STEP_CONGRATULATIONS_DESCRIPTION', 30, 'bottom', '', 0, 1, 'administrator/index.php?option=com_content&view=article&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(31, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_NEW_DESCRIPTION', 31, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_categories&view=categories&extension=com_content', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(32, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_TITLE_DESCRIPTION', 32, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(33, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_ALIAS_DESCRIPTION', 33, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(34, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_CONTENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_CONTENT_DESCRIPTION', 34, 'bottom', '#jform_description,#jform_description_ifr', 2, 3, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
...
(36, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_STATUS_DESCRIPTION', 36, 'bottom', '#jform_published', 2, 3, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(37, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_ACCESS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_ACCESS_DESCRIPTION', 37, 'bottom', '#jform_access', 2, 3, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
...
(39, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_NOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_NOTE_DESCRIPTION', 39, 'top', '#jform_note', 2, 2, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(40, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_VERSIONNOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_VERSIONNOTE_DESCRIPTION', 40, 'top', '#jform_version_note', 2, 2, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
...
(42, 4, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CATEGORIES_STEP_CONGRATULATIONS_DESCRIPTION', 42, 'bottom', '', 0, 1, 'administrator/index.php?option=com_categories&view=category&layout=edit&extension=com_content', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(43, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_NEW_DESCRIPTION', 43, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_menus&view=menus', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(44, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_TITLE_DESCRIPTION', 44, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_menus&view=menu&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(45, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_UNIQUENAME_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_UNIQUENAME_DESCRIPTION', 45, 'top', '#jform_menutype', 2, 2, 'administrator/index.php?option=com_menus&view=menu&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(46, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_DESCRIPTION_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_DESCRIPTION_DESCRIPTION', 46, 'top', '#jform_menudescription', 2, 2, 'administrator/index.php?option=com_menus&view=menu&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(47, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_SAVECLOSE_DESCRIPTION', 47, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_menus&view=menu&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(48, 5, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_MENUS_STEP_CONGRATULATIONS_DESCRIPTION', 48, 'bottom', '', 0, 1, 'administrator/index.php?option=com_menus&view=menu&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(49, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_NEW_DESCRIPTION', 49, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_tags&view=tags', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(50, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_TITLE_DESCRIPTION', 50, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(51, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_ALIAS_DESCRIPTION', 51, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(52, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_CONTENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_CONTENT_DESCRIPTION', 52, 'bottom', '#jform_description,#jform_description_ifr', 2, 3, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(53, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_PARENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_PARENT_DESCRIPTION', 53, 'top', 'joomla-field-fancy-select .choices[data-type=select-one]', 2, 3, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(54, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_STATUS_DESCRIPTION', 54, 'bottom', '#jform_published', 2, 3, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(55, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_ACCESS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_ACCESS_DESCRIPTION', 55, 'bottom', '#jform_access', 2, 3, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(56, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_NOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_NOTE_DESCRIPTION', 56, 'top', '#jform_note', 2, 2, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(57, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_VERSIONNOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_VERSIONNOTE_DESCRIPTION', 57, 'top', '#jform_version_note', 2, 2, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(58, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_SAVECLOSE_DESCRIPTION', 58, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(59, 6, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_TAGS_STEP_CONGRATULATIONS_DESCRIPTION', 59, 'bottom', '', 0, 1, 'administrator/index.php?option=com_tags&view=tag&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(60, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_NEW_DESCRIPTION', 60, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_banners&view=banners', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(61, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_TITLE_DESCRIPTION', 61, 'bottom', '#jform_name', 2, 2, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(62, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_ALIAS_DESCRIPTION', 62, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(63, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_DETAILS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_DETAILS_DESCRIPTION', 63, 'bottom', '.col-lg-9', 2, 3, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(64, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_STATUS_DESCRIPTION', 64, 'bottom', '#jform_state', 2, 3, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(65, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_CATEGORY_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_CATEGORY_DESCRIPTION', 65, 'top', 'joomla-field-fancy-select .choices[data-type=select-one]', 2, 3, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(66, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_PINNED_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_PINNED_DESCRIPTION', 66, 'bottom', '#jform_sticky1', 2, 3, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(67, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_VERSIONNOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_VERSIONNOTE_DESCRIPTION', 67, 'top', '#jform_version_note', 2, 2, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(68, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_SAVECLOSE_DESCRIPTION', 68, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(69, 7, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_BANNERS_STEP_CONGRATULATIONS_DESCRIPTION', 69, 'bottom', '', 0, 1, 'administrator/index.php?option=com_banners&view=banner&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(70, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_NEW_DESCRIPTION', 70, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_contact&view=contacts', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(71, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_TITLE_DESCRIPTION', 71, 'bottom', '#jform_name', 2, 2, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(72, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_ALIAS_DESCRIPTION', 72, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(73, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_DETAILS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_DETAILS_DESCRIPTION', 73, 'bottom', '.col-lg-9', 0, 1, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(74, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_STATUS_DESCRIPTION', 74, 'bottom', '#jform_published', 2, 3, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(75, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_CATEGORY_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_CATEGORY_DESCRIPTION', 75, 'top', 'joomla-field-fancy-select .choices[data-type=select-one]', 2, 3, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(76, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_FEATURED_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_FEATURED_DESCRIPTION', 76, 'bottom', '#jform_featured0', 2, 3, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(77, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_ACCESS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_ACCESS_DESCRIPTION', 77, 'bottom', '#jform_access', 2, 3, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(78, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_TAGS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_TAGS_DESCRIPTION', 78, 'top', 'joomla-field-fancy-select .choices[data-type=select-multiple]', 2, 3, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(79, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_VERSIONNOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_VERSIONNOTE_DESCRIPTION', 79, 'top', '#jform_version_note', 2, 2, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(80, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_SAVECLOSE_DESCRIPTION', 80, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(81, 8, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_CONTACTS_STEP_CONGRATULATIONS_DESCRIPTION', 81, 'bottom', '', 0, 1, 'administrator/index.php?option=com_contact&view=contact&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(82, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_NEW_DESCRIPTION', 82, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_newsfeeds&view=newsfeeds', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(83, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_TITLE_DESCRIPTION', 83, 'bottom', '#jform_name', 2, 2, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(84, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_ALIAS_DESCRIPTION', 84, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(85, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_LINK_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_LINK_DESCRIPTION', 85, 'bottom', '#jform_link', 2, 2, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(86, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_DESCRIPTION_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_DESCRIPTION_DESCRIPTION', 86, 'bottom', '#jform_description,#jform_description_ifr', 2, 3, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(87, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_STATUS_DESCRIPTION', 87, 'bottom', '#jform_published', 2, 3, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(88, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_CATEGORY_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_CATEGORY_DESCRIPTION', 88, 'top', 'joomla-field-fancy-select .choices[data-type=select-one]', 2, 3, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(89, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_ACCESS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_ACCESS_DESCRIPTION', 89, 'bottom', '#jform_access', 2, 3, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(90, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_TAGS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_TAGS_DESCRIPTION', 90, 'top', 'joomla-field-fancy-select .choices[data-type=select-multiple]', 2, 3, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(91, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_VERSIONNOTE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_VERSIONNOTE_DESCRIPTION', 91, 'top', '#jform_version_note', 2, 2, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(92, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_SAVECLOSE_DESCRIPTION', 92, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(93, 9, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_NEWSFEEDS_STEP_CONGRATULATIONS_DESCRIPTION', 93, 'bottom', '', 0, 1, 'administrator/index.php?option=com_newsfeeds&view=newsfeed&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(94, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_NEW_DESCRIPTION', 94, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_finder&view=filters', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(95, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_TITLE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_TITLE_DESCRIPTION', 95, 'bottom', '#jform_title', 2, 2, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(96, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_ALIAS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_ALIAS_DESCRIPTION', 96, 'bottom', '#jform_alias', 2, 2, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(97, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_CONTENT_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_CONTENT_DESCRIPTION', 97, 'bottom', '.col-lg-9', 0, 1, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(98, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_STATUS_DESCRIPTION', 98, 'bottom', '#jform_state', 2, 3, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(99, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_SAVECLOSE_DESCRIPTION', 99, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(100, 10, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_SMARTSEARCH_STEP_CONGRATULATIONS_DESCRIPTION', 100, 'bottom', '', 0, 1, 'administrator/index.php?option=com_finder&view=filter&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(101, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_NEW_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_NEW_DESCRIPTION', 101, 'bottom', '.button-new', 2, 1, 'administrator/index.php?option=com_users&view=user&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(102, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_NAME_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_NAME_DESCRIPTION', 102, 'bottom', '#jform_name', 2, 2, 'administrator/index.php?option=com_users&view=user&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(103, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_LOGINNAME_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_LOGINNAME_DESCRIPTION', 103, 'bottom', '#jform_username', 2, 2, 'administrator/index.php?option=com_users&view=user&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(104, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORD_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORD_DESCRIPTION', 104, 'bottom', '#jform_password', 2, 2, 'administrator/index.php?option=com_users&view=user&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(105, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORD2_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORD2_DESCRIPTION', 105, 'bottom', '#jform_password2', 2, 2, 'administrator/index.php?option=com_users&view=user&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(106, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_EMAIL_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_EMAIL_DESCRIPTION', 106, 'bottom', '#jform_email', 2, 2, 'administrator/index.php?option=com_users&view=user&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(107, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_SYSTEMEMAIL_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_SYSTEMEMAIL_DESCRIPTION', 107, 'top', '#jform_sendEmail0', 2, 3, 'administrator/index.php?option=com_users&view=user&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(108, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_STATUS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_STATUS_DESCRIPTION', 108, 'top', '#jform_block0', 2, 3, 'administrator/index.php?option=com_users&view=user&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(109, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORDRESET_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_PASSWORDRESET_DESCRIPTION', 109, 'top', '#jform_requireReset0', 2, 3, 'administrator/index.php?option=com_users&view=user&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(110, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_SAVECLOSE_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_SAVECLOSE_DESCRIPTION', 110, 'bottom', '#save-group-children-save .button-save', 2, 1, 'administrator/index.php?option=com_users&view=user&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', ''),
(111, 11, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_CONGRATULATIONS_TITLE', 1, 'COM_GUIDEDTOURS_TOUR_USERS_STEP_CONGRATULATIONS_DESCRIPTION', 111, 'bottom', '', 0, 1, 'administrator/index.php?option=com_users&view=user&layout=edit', '2024-02-15 00:38:36', 0, '2024-02-15 00:38:36', 0, NULL, NULL, '*', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_history`
--

CREATE TABLE `pdh_history` (
...
--
-- Estructura de tabla para la tabla `pdh_languages`
--

CREATE TABLE `pdh_languages` (
...
--
-- Volcado de datos para la tabla `pdh_languages`
--

INSERT INTO `pdh_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 2),
(2, 97, 'es-ES', 'Spanish (es-ES)', 'Español (España)', 'es', 'es_es', '', NULL, '', '', 0, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_mail_templates`
--

CREATE TABLE `pdh_mail_templates` (
...
--
-- Volcado de datos para la tabla `pdh_mail_templates`
--

INSERT INTO `pdh_mail_templates` (`template_id`, `extension`, `language`, `subject`, `body`, `htmlbody`, `attachments`, `params`) VALUES
...
--
-- Estructura de tabla para la tabla `pdh_menu`
--

CREATE TABLE `pdh_menu` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `pdh_menu`
--

INSERT INTO `pdh_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`) VALUES
...
--
-- Estructura de tabla para la tabla `pdh_menu_types`
--

CREATE TABLE `pdh_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `pdh_menu_types`
--

INSERT INTO `pdh_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_messages`
--

CREATE TABLE `pdh_messages` (
...
--
-- Estructura de tabla para la tabla `pdh_messages_cfg`
--

CREATE TABLE `pdh_messages_cfg` (
...
--
-- Estructura de tabla para la tabla `pdh_modules`
--

CREATE TABLE `pdh_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla `pdh_modules`
--

INSERT INTO `pdh_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(110, 98, 'Astroid Clear Cache', '', '', 1, 'status', NULL, NULL, NULL, NULL, 1, 'mod_astroid_clear_cache', 1, 1, '{\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"style\":\"0\",\"module_tag\":\"div\",\"bootstrap_size\":\"0\",\"header_tag\":\"h3\",\"header_class\":\"\"}', 1, '*'),
(111, 99, 'Astroid Menu', '', '', 1, 'status', NULL, NULL, NULL, NULL, 1, 'mod_astroid_menu', 1, 1, '{\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"style\":\"0\",\"module_tag\":\"div\",\"bootstrap_size\":\"0\",\"header_tag\":\"h3\",\"header_class\":\"\"}', 0, '*'),
(112, 100, 'busqueda', '', NULL, 1, 'busqueda', NULL, NULL, NULL, NULL, 1, 'mod_finder', 1, 1, '{\"searchfilter\":\"\",\"show_autosuggest\":1,\"show_advanced\":0,\"show_label\":1,\"alt_label\":\"\",\"show_button\":1,\"opensearch\":1,\"opensearch_name\":\"\",\"set_itemid\":0,\"layout\":\"_:default\",\"moduleclass_sfx\":\"\",\"module_tag\":\"div\",\"bootstrap_size\":\"0\",\"header_tag\":\"h3\",\"header_class\":\"\",\"style\":\"0\"}', 0, '*');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_modules_menu`
--

CREATE TABLE `pdh_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT 0,
  `menuid` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `pdh_modules_menu`
--

INSERT INTO `pdh_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla `pdh_newsfeeds`
--

CREATE TABLE `pdh_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT 0,
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_overrider`
--

CREATE TABLE `pdh_overrider` (
...
--
-- Estructura de tabla para la tabla `pdh_postinstall_messages`
--

CREATE TABLE `pdh_postinstall_messages` (
...
--
-- Volcado de datos para la tabla `pdh_postinstall_messages`
--

INSERT INTO `pdh_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Estructura de tabla para la tabla `pdh_privacy_consents`
--

CREATE TABLE `pdh_privacy_consents` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `state` int(11) NOT NULL DEFAULT 1,
  `created` datetime NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_privacy_requests`
--

CREATE TABLE `pdh_privacy_requests` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_redirect_links`
--

CREATE TABLE `pdh_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_scheduler_tasks`
--

CREATE TABLE `pdh_scheduler_tasks` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
  `title` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `pdh_schemas`
--

CREATE TABLE `pdh_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `pdh_schemas`
--

INSERT INTO `pdh_schemas` (`extension_id`, `version_id`) VALUES
(229, '4.4.0-2023-09-13');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_session`
--

CREATE TABLE `pdh_session` (
...
--
-- Volcado de datos para la tabla `pdh_session`
--

INSERT INTO `pdh_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x646366686f6b3131336174336e686e6a72676c36353564743835, 0, 1, 1707957770, 'joomla|s:700:\"\";', 0, ''),
(0x696c6f7572703334306b69383732636f64616c6c37306f356e76, 1, 0, 1707957789, 'joomla|s:1804:\"\";', 632, 'administrador');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_tags`
--

CREATE TABLE `pdh_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `lft` int(11) NOT NULL DEFAULT 0,
  `rgt` int(11) NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `pdh_tags`
--

INSERT INTO `pdh_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '', '', '', '', 632, '2024-02-15 00:38:33', '', 632, '2024-02-15 00:38:33', '', '', 0, '*', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_template_overrides`
--

CREATE TABLE `pdh_template_overrides` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_template_styles`
--

CREATE TABLE `pdh_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
  `template` varchar(50) NOT NULL DEFAULT '',
  `client_id` tinyint(3) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `pdh_template_styles`
--

INSERT INTO `pdh_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `inheritable`, `parent`, `params`) VALUES
...
(12, 'astroid_template_two', 0, '0', 'astroid_template_two - Predeterminado', 1, '', '{\"astroid\":12}'),
(13, 'astroid_template_one', 0, '0', 'astroid_template_one - Predeterminado', 1, '', '{\"astroid\":13}'),
(14, 'astroid_template_zero', 0, '1', 'astroid_template_zero - Predeterminado', 1, '', '{\"astroid\":14}');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_ucm_base`
--

CREATE TABLE `pdh_ucm_base` (
...
--
-- Estructura de tabla para la tabla `pdh_ucm_content`
--

CREATE TABLE `pdh_ucm_content` (
...
--
-- Estructura de tabla para la tabla `pdh_updates`
--

CREATE TABLE `pdh_updates` (
...
--
-- Volcado de datos para la tabla `pdh_updates`
--

INSERT INTO `pdh_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `changelogurl`, `extra_query`) VALUES
...
(60, 2, 0, 'Basque', '', 'pkg_eu-ES', 'package', '', 0, '4.4.3.5', '', 'https://update.joomla.org/language/details4/eu-ES_details.xml', '', '', ''),
(61, 2, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/be-BY_details.xml', '', '', ''),
(62, 2, 0, 'Bulgarian', '', 'pkg_bg-BG', 'package', '', 0, '4.3.3.1', '', 'https://update.joomla.org/language/details4/bg-BG_details.xml', '', '', ''),
(63, 2, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '4.0.4.2', '', 'https://update.joomla.org/language/details4/ca-ES_details.xml', '', '', ''),
(64, 2, 0, 'Chinese, Simplified', '', 'pkg_zh-CN', 'package', '', 0, '4.3.0.2', '', 'https://update.joomla.org/language/details4/zh-CN_details.xml', '', '', ''),
(65, 2, 0, 'Chinese, Traditional', '', 'pkg_zh-TW', 'package', '', 0, '4.2.3.1', '', 'https://update.joomla.org/language/details4/zh-TW_details.xml', '', '', ''),
(66, 2, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '4.3.1.1', '', 'https://update.joomla.org/language/details4/hr-HR_details.xml', '', '', ''),
(67, 2, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '4.4.0.1', '', 'https://update.joomla.org/language/details4/cs-CZ_details.xml', '', '', ''),
(68, 2, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/da-DK_details.xml', '', '', ''),
(69, 2, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/nl-NL_details.xml', '', '', ''),
(70, 2, 0, 'English, Australia', '', 'pkg_en-AU', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/en-AU_details.xml', '', '', ''),
(71, 2, 0, 'English, Canada', '', 'pkg_en-CA', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/en-CA_details.xml', '', '', ''),
(72, 2, 0, 'English, New Zealand', '', 'pkg_en-NZ', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/en-NZ_details.xml', '', '', ''),
(73, 2, 0, 'English, USA', '', 'pkg_en-US', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/en-US_details.xml', '', '', ''),
(74, 2, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '4.4.1.2', '', 'https://update.joomla.org/language/details4/et-EE_details.xml', '', '', ''),
(75, 2, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '4.1.1.2', '', 'https://update.joomla.org/language/details4/fi-FI_details.xml', '', '', ''),
(76, 2, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '4.4.0.1', '', 'https://update.joomla.org/language/details4/nl-BE_details.xml', '', '', ''),
(77, 2, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/fr-FR_details.xml', '', '', ''),
(78, 2, 0, 'French, Canada', '', 'pkg_fr-CA', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/fr-CA_details.xml', '', '', ''),
(79, 2, 0, 'Georgian', '', 'pkg_ka-GE', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/ka-GE_details.xml', '', '', ''),
(80, 2, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/de-DE_details.xml', '', '', ''),
(81, 2, 0, 'German, Austria', '', 'pkg_de-AT', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/de-AT_details.xml', '', '', ''),
(82, 2, 0, 'German, Liechtenstein', '', 'pkg_de-LI', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/de-LI_details.xml', '', '', ''),
(83, 2, 0, 'German, Luxembourg', '', 'pkg_de-LU', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/de-LU_details.xml', '', '', ''),
(84, 2, 0, 'German, Switzerland', '', 'pkg_de-CH', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/de-CH_details.xml', '', '', ''),
(85, 2, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '4.4.2.2', '', 'https://update.joomla.org/language/details4/el-GR_details.xml', '', '', ''),
(86, 2, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/hu-HU_details.xml', '', '', ''),
(87, 2, 0, 'Irish', '', 'pkg_ga-IE', 'package', '', 0, '4.2.8.1', '', 'https://update.joomla.org/language/details4/ga-IE_details.xml', '', '', ''),
(88, 2, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/it-IT_details.xml', '', '', ''),
(89, 2, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/ja-JP_details.xml', '', '', ''),
...
(97, 2, 0, 'Persian Farsi', '', 'pkg_fa-IR', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/fa-IR_details.xml', '', '', ''),
(98, 2, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '4.4.0.2', '', 'https://update.joomla.org/language/details4/pl-PL_details.xml', '', '', ''),
(99, 2, 0, 'Portuguese, Brazil', '', 'pkg_pt-BR', 'package', '', 0, '4.0.3.1', '', 'https://update.joomla.org/language/details4/pt-BR_details.xml', '', '', ''),
(100, 2, 0, 'Portuguese, Portugal', '', 'pkg_pt-PT', 'package', '', 0, '4.0.0-rc4.2', '', 'https://update.joomla.org/language/details4/pt-PT_details.xml', '', '', ''),
(101, 2, 0, 'Romanian', '', 'pkg_ro-RO', 'package', '', 0, '4.3.1.1', '', 'https://update.joomla.org/language/details4/ro-RO_details.xml', '', '', ''),
(102, 2, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/ru-RU_details.xml', '', '', ''),
(103, 2, 0, 'Serbian, Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '4.3.2.1', '', 'https://update.joomla.org/language/details4/sr-RS_details.xml', '', '', ''),
(104, 2, 0, 'Serbian, Latin', '', 'pkg_sr-YU', 'package', '', 0, '4.3.2.2', '', 'https://update.joomla.org/language/details4/sr-YU_details.xml', '', '', ''),
(105, 2, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '4.4.1.1', '', 'https://update.joomla.org/language/details4/sk-SK_details.xml', '', '', ''),
(106, 2, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/sl-SI_details.xml', '', '', ''),
(107, 2, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/sv-SE_details.xml', '', '', ''),
(108, 2, 0, 'Tamil, India', '', 'pkg_ta-IN', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/ta-IN_details.xml', '', '', ''),
(109, 2, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/th-TH_details.xml', '', '', ''),
(110, 2, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/tr-TR_details.xml', '', '', ''),
(111, 2, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '4.4.1.1', '', 'https://update.joomla.org/language/details4/uk-UA_details.xml', '', '', ''),
(112, 2, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '4.2.2.1', '', 'https://update.joomla.org/language/details4/vi-VN_details.xml', '', '', ''),
(113, 2, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '4.4.2.1', '', 'https://update.joomla.org/language/details4/cy-GB_details.xml', '', '', ''),
(114, 1, 229, 'Joomla', '', 'joomla', 'file', '', 0, '4.4.2', '', 'https://update.joomla.org/core/j4/default.xml', '', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_update_sites`
--

CREATE TABLE `pdh_update_sites` (
...
--
-- Volcado de datos para la tabla `pdh_update_sites`
--

INSERT INTO `pdh_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`, `checked_out`, `checked_out_time`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1707957566, '', NULL, NULL),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_4.xml', 1, 1707957552, '', NULL, NULL),
(3, 'Joomla! Update Component', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1707957575, '', NULL, NULL),
(4, 'Astroid Framework', 'extension', 'https://raw.githubusercontent.com/templaza/astroid-framework/master/astroid_framework.xml', 1, 1707957715, '', NULL, NULL),
(5, 'Astroid Two Template', 'extension', 'https://raw.githubusercontent.com/templaza/astroid-framework/two-template/two_template_update.xml', 1, 1707957716, '', NULL, NULL),
(6, 'astroid_framework', 'extension', 'https://raw.githubusercontent.com/templaza/astroid-framework/one-template/one_template_update.xml', 1, 1707957716, '', NULL, NULL),
(7, 'astroid_framework', 'extension', 'https://raw.githubusercontent.com/templaza/astroid-framework/zero-template/zero_template_update.xml', 1, 1707957716, '', NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_update_sites_extensions`
--

CREATE TABLE `pdh_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT 0,
  `extension_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Volcado de datos para la tabla `pdh_update_sites_extensions`
--

INSERT INTO `pdh_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 229),
(2, 230),
(2, 237),
(3, 24),
...
--
-- Estructura de tabla para la tabla `pdh_usergroups`
--

CREATE TABLE `pdh_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla `pdh_usergroups`
--

INSERT INTO `pdh_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla `pdh_users`
--

CREATE TABLE `pdh_users` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `pdh_users`
--

INSERT INTO `pdh_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`, `authProvider`) VALUES
(632, 'PDH', 'administrador', 'jereajpacajaf@gmail.com', '$2y$10$XVgJGRWrNvpIvBwqEVp6qO6fujnC7KW2MqW2OsKiYYUWuu0v323/q', 0, 1, '2024-02-15 00:38:45', '2024-02-15 00:39:33', '0', '', NULL, 0, '', '', 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_user_keys`
--

CREATE TABLE `pdh_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Estructura de tabla para la tabla `pdh_user_mfa`
--

CREATE TABLE `pdh_user_mfa` (
  `id` int(11) NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL,
  `title` varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `pdh_user_notes`
--

CREATE TABLE `pdh_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `catid` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
--
-- Estructura de tabla para la tabla `pdh_user_profiles`
--

CREATE TABLE `pdh_user_profiles` (
...
--
-- Estructura de tabla para la tabla `pdh_user_usergroup_map`
--

CREATE TABLE `pdh_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `pdh_user_usergroup_map`
--

INSERT INTO `pdh_user_usergroup_map` (`user_id`, `group_id`) VALUES
(632, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_viewlevels`
--

CREATE TABLE `pdh_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT 0,
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Volcado de datos para la tabla `pdh_viewlevels`
--

INSERT INTO `pdh_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Estructura de tabla para la tabla `pdh_webauthn_credentials`
--

CREATE TABLE `pdh_webauthn_credentials` (
...
--
-- Estructura de tabla para la tabla `pdh_workflows`
--

CREATE TABLE `pdh_workflows` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `pdh_workflows`
--

INSERT INTO `pdh_workflows` (`id`, `asset_id`, `published`, `title`, `description`, `extension`, `default`, `ordering`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`) VALUES
(1, 56, 1, 'COM_WORKFLOW_BASIC_WORKFLOW', '', 'com_content.article', 1, 1, '2024-02-15 00:38:34', 632, '2024-02-15 00:38:34', 632, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_workflow_associations`
--

CREATE TABLE `pdh_workflow_associations` (
...
--
-- Estructura de tabla para la tabla `pdh_workflow_stages`
--

CREATE TABLE `pdh_workflow_stages` (
  `id` int(11) NOT NULL,
  `asset_id` int(11) DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
...
--
-- Volcado de datos para la tabla `pdh_workflow_stages`
--

INSERT INTO `pdh_workflow_stages` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `default`, `checked_out_time`, `checked_out`) VALUES
(1, 57, 1, 1, 1, 'COM_WORKFLOW_BASIC_STAGE', '', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `pdh_workflow_transitions`
--

CREATE TABLE `pdh_workflow_transitions` (
  `id` int(11) NOT NULL,
  `asset_id` int(11) DEFAULT 0,
  `ordering` int(11) NOT NULL DEFAULT 0,
  `workflow_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `pdh_workflow_transitions`
--

INSERT INTO `pdh_workflow_transitions` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `from_stage_id`, `to_stage_id`, `options`, `checked_out_time`, `checked_out`) VALUES
...
--
-- Indices de la tabla `pdh_action_logs`
--
ALTER TABLE `pdh_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_action_logs_extensions`
--
ALTER TABLE `pdh_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pdh_action_logs_users`
--
ALTER TABLE `pdh_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indices de la tabla `pdh_action_log_config`
--
ALTER TABLE `pdh_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pdh_assets`
--
ALTER TABLE `pdh_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_associations`
--
ALTER TABLE `pdh_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indices de la tabla `pdh_banners`
--
ALTER TABLE `pdh_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_banner_clients`
--
ALTER TABLE `pdh_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indices de la tabla `pdh_banner_tracks`
--
ALTER TABLE `pdh_banner_tracks`
...
--
-- Indices de la tabla `pdh_categories`
--
ALTER TABLE `pdh_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_contact_details`
--
ALTER TABLE `pdh_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indices de la tabla `pdh_content`
--
ALTER TABLE `pdh_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `pdh_contentitem_tag_map`
--
ALTER TABLE `pdh_contentitem_tag_map`
...
--
-- Indices de la tabla `pdh_content_frontpage`
--
ALTER TABLE `pdh_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `pdh_content_rating`
--
ALTER TABLE `pdh_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `pdh_content_types`
--
ALTER TABLE `pdh_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indices de la tabla `pdh_extensions`
--
ALTER TABLE `pdh_extensions`
...
--
-- Indices de la tabla `pdh_fields`
--
ALTER TABLE `pdh_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `pdh_fields_categories`
--
ALTER TABLE `pdh_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indices de la tabla `pdh_fields_groups`
--
ALTER TABLE `pdh_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `pdh_fields_values`
--
ALTER TABLE `pdh_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indices de la tabla `pdh_finder_filters`
--
ALTER TABLE `pdh_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `pdh_finder_links`
--
ALTER TABLE `pdh_finder_links`
...
--
-- Indices de la tabla `pdh_finder_links_terms`
--
ALTER TABLE `pdh_finder_links_terms`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `pdh_finder_logging`
--
ALTER TABLE `pdh_finder_logging`
  ADD PRIMARY KEY (`md5sum`),
  ADD KEY `searchterm` (`searchterm`(191));

--
-- Indices de la tabla `pdh_finder_taxonomy`
--
ALTER TABLE `pdh_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_state` (`state`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_path` (`path`(100)),
...
--
-- Indices de la tabla `pdh_finder_taxonomy_map`
--
ALTER TABLE `pdh_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indices de la tabla `pdh_finder_terms`
--
ALTER TABLE `pdh_finder_terms`
...
--
-- Indices de la tabla `pdh_finder_terms_common`
--
ALTER TABLE `pdh_finder_terms_common`
  ADD UNIQUE KEY `idx_term_language` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indices de la tabla `pdh_finder_tokens`
--
ALTER TABLE `pdh_finder_tokens`
...
--
-- Indices de la tabla `pdh_finder_tokens_aggregate`
--
ALTER TABLE `pdh_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indices de la tabla `pdh_finder_types`
--
ALTER TABLE `pdh_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indices de la tabla `pdh_guidedtours`
--
ALTER TABLE `pdh_guidedtours`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_state` (`published`),
  ADD KEY `idx_language` (`language`);
...
--
-- Indices de la tabla `pdh_guidedtour_steps`
--
ALTER TABLE `pdh_guidedtour_steps`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_history`
--
ALTER TABLE `pdh_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indices de la tabla `pdh_languages`
--
ALTER TABLE `pdh_languages`
...
--
-- Indices de la tabla `pdh_mail_templates`
--
ALTER TABLE `pdh_mail_templates`
  ADD PRIMARY KEY (`template_id`,`language`);

--
-- Indices de la tabla `pdh_menu`
--
ALTER TABLE `pdh_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_menu_types`
--
ALTER TABLE `pdh_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indices de la tabla `pdh_messages`
--
ALTER TABLE `pdh_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indices de la tabla `pdh_messages_cfg`
--
ALTER TABLE `pdh_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indices de la tabla `pdh_modules`
--
ALTER TABLE `pdh_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_modules_menu`
--
ALTER TABLE `pdh_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indices de la tabla `pdh_newsfeeds`
--
ALTER TABLE `pdh_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indices de la tabla `pdh_overrider`
--
ALTER TABLE `pdh_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pdh_postinstall_messages`
--
ALTER TABLE `pdh_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indices de la tabla `pdh_privacy_consents`
--
ALTER TABLE `pdh_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indices de la tabla `pdh_privacy_requests`
--
ALTER TABLE `pdh_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `pdh_redirect_links`
--
ALTER TABLE `pdh_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modified` (`modified_date`);

--
-- Indices de la tabla `pdh_scheduler_tasks`
--
ALTER TABLE `pdh_scheduler_tasks`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_schemas`
--
ALTER TABLE `pdh_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indices de la tabla `pdh_session`
--
ALTER TABLE `pdh_session`
...
--
-- Indices de la tabla `pdh_tags`
--
ALTER TABLE `pdh_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_template_overrides`
--
ALTER TABLE `pdh_template_overrides`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_extension_id` (`extension_id`);

--
-- Indices de la tabla `pdh_template_styles`
--
ALTER TABLE `pdh_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
...
--
-- Indices de la tabla `pdh_ucm_base`
--
ALTER TABLE `pdh_ucm_base`
...
--
-- Indices de la tabla `pdh_ucm_content`
--
ALTER TABLE `pdh_ucm_content`
...
--
-- Indices de la tabla `pdh_updates`
--
ALTER TABLE `pdh_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indices de la tabla `pdh_update_sites`
--
ALTER TABLE `pdh_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indices de la tabla `pdh_update_sites_extensions`
--
ALTER TABLE `pdh_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indices de la tabla `pdh_usergroups`
--
ALTER TABLE `pdh_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_users`
--
ALTER TABLE `pdh_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_user_keys`
--
ALTER TABLE `pdh_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indices de la tabla `pdh_user_mfa`
--
ALTER TABLE `pdh_user_mfa`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indices de la tabla `pdh_user_notes`
--
ALTER TABLE `pdh_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indices de la tabla `pdh_user_profiles`
--
ALTER TABLE `pdh_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indices de la tabla `pdh_user_usergroup_map`
--
ALTER TABLE `pdh_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indices de la tabla `pdh_viewlevels`
--
ALTER TABLE `pdh_viewlevels`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_assetgroup_title_lookup` (`title`);

--
-- Indices de la tabla `pdh_webauthn_credentials`
--
ALTER TABLE `pdh_webauthn_credentials`
  ADD PRIMARY KEY (`id`(100)),
  ADD KEY `user_id` (`user_id`(100));

--
-- Indices de la tabla `pdh_workflows`
--
ALTER TABLE `pdh_workflows`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_workflow_associations`
--
ALTER TABLE `pdh_workflow_associations`
...
--
-- Indices de la tabla `pdh_workflow_stages`
--
ALTER TABLE `pdh_workflow_stages`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `pdh_workflow_transitions`
--
ALTER TABLE `pdh_workflow_transitions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_title` (`title`(191)),
  ADD KEY `idx_asset_id` (`asset_id`),
  ADD KEY `idx_checked_out` (`checked_out`),
...
--
-- AUTO_INCREMENT de la tabla `pdh_action_logs`
--
ALTER TABLE `pdh_action_logs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `pdh_action_logs_extensions`
--
ALTER TABLE `pdh_action_logs_extensions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT de la tabla `pdh_action_log_config`
--
ALTER TABLE `pdh_action_log_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `pdh_assets`
--
ALTER TABLE `pdh_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT de la tabla `pdh_banners`
--
ALTER TABLE `pdh_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_banner_clients`
--
ALTER TABLE `pdh_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_categories`
--
ALTER TABLE `pdh_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `pdh_contact_details`
--
ALTER TABLE `pdh_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_content`
--
ALTER TABLE `pdh_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_content_types`
--
ALTER TABLE `pdh_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT de la tabla `pdh_extensions`
--
ALTER TABLE `pdh_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=246;

--
-- AUTO_INCREMENT de la tabla `pdh_fields`
--
ALTER TABLE `pdh_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_fields_groups`
--
ALTER TABLE `pdh_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_finder_filters`
--
ALTER TABLE `pdh_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_finder_links`
--
ALTER TABLE `pdh_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_finder_taxonomy`
--
ALTER TABLE `pdh_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pdh_finder_terms`
--
ALTER TABLE `pdh_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_finder_types`
--
ALTER TABLE `pdh_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_guidedtours`
--
ALTER TABLE `pdh_guidedtours`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `pdh_guidedtour_steps`
--
ALTER TABLE `pdh_guidedtour_steps`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;

--
-- AUTO_INCREMENT de la tabla `pdh_history`
--
ALTER TABLE `pdh_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_languages`
--
ALTER TABLE `pdh_languages`
  MODIFY `lang_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `pdh_menu`
--
ALTER TABLE `pdh_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT de la tabla `pdh_menu_types`
--
ALTER TABLE `pdh_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pdh_messages`
--
ALTER TABLE `pdh_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_modules`
--
ALTER TABLE `pdh_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;

--
-- AUTO_INCREMENT de la tabla `pdh_newsfeeds`
--
ALTER TABLE `pdh_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_overrider`
--
ALTER TABLE `pdh_overrider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT de la tabla `pdh_postinstall_messages`
--
ALTER TABLE `pdh_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `pdh_privacy_consents`
--
ALTER TABLE `pdh_privacy_consents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_privacy_requests`
--
ALTER TABLE `pdh_privacy_requests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_redirect_links`
--
ALTER TABLE `pdh_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_scheduler_tasks`
--
ALTER TABLE `pdh_scheduler_tasks`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_tags`
--
ALTER TABLE `pdh_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pdh_template_overrides`
--
ALTER TABLE `pdh_template_overrides`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_template_styles`
--
ALTER TABLE `pdh_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `pdh_ucm_content`
--
ALTER TABLE `pdh_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_updates`
--
ALTER TABLE `pdh_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT de la tabla `pdh_update_sites`
--
ALTER TABLE `pdh_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `pdh_usergroups`
--
ALTER TABLE `pdh_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `pdh_users`
--
ALTER TABLE `pdh_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=633;

--
-- AUTO_INCREMENT de la tabla `pdh_user_keys`
--
ALTER TABLE `pdh_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_user_mfa`
--
ALTER TABLE `pdh_user_mfa`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_user_notes`
--
ALTER TABLE `pdh_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pdh_viewlevels`
--
ALTER TABLE `pdh_viewlevels`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `pdh_workflows`
--
ALTER TABLE `pdh_workflows`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pdh_workflow_stages`
--
ALTER TABLE `pdh_workflow_stages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `pdh_workflow_transitions`
--
ALTER TABLE `pdh_workflow_transitions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
