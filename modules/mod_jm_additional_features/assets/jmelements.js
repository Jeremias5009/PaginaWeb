(function($){
	...
	JMElements.prototype = {
		...
		editElement: function(index) {
			...
			$('#jform_params_item_readmore0').click(function (){
				$('#'+this.id).attr('checked',true);
				$('#jform_params_item_readmore1').attr('checked',false);
				$(`label[for="jform_params_item_readmore1"]`).removeClass('active');
				$(`label[for="jform_params_item_readmore1"]`).removeClass('btn-danger');
				$(`label[for="jform_params_item_readmore1"]`).removeClass('btn-success');
				$(`label[for="${this.id}"]`).addClass('active');
				$(`label[for="${this.id}"]`).addClass('btn-danger');
				$(`label[for="${this.id}"]`).addClass('btn-success');
			});
			
			$('#jform_params_item_readmore1').click(function (){
				$('#'+this.id).attr('checked',true);
				$('#jform_params_item_readmore0').attr('checked',false);
				$(`label[for="jform_params_item_readmore0"]`).removeClass('active');
				$(`label[for="jform_params_item_readmore0"]`).removeClass('btn-danger');
				$(`label[for="jform_params_item_readmore0"]`).removeClass('btn-success');
				$(`label[for="${this.id}"]`).addClass('active');
				$(`label[for="${this.id}"]`).addClass('btn-danger');
				$(`label[for="${this.id}"]`).addClass('btn-success');
			});
